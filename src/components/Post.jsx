      ...
      <div className="ml-6 w-full h-full flex flex-col items-start">
        ...
        {/* Box for the information */}
            ...
            <div className="flex justify-between">
                ...
                <button onClick={()=>{setIsMenu(!isMenu)}} className="text-xs align-middle ml-2 text-neutral-grayishBlue hover:text-primary-moderateBlue transition-colors duration-200">
                ...
                </button>
                {isMenu &&  (
